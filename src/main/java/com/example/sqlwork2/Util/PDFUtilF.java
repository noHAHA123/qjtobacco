...
public class PDFUtilF {
    public static void A(String dept,String Dalei,String date,String amount,String name,String accno,String sequenceNo) throws IOException {
